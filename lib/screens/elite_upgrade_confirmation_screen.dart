          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: const Color(
                  0xFFD1E4FF,
                ).withOpacity(0.2), // primary-fixed/20
              ),
            ),
          ),
          Positioned(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Column(
                ...
                children: const [
                  ...
                  Text(
                    '/month',
                    style: TextStyle(fontSize: 16, color: Color(0xFF414750)),
                  ),
                ],
              ),
            ],
          ...
          _buildFeatureItem(
            ...
            'Build instant trust with elite clients.',
          ),
          const SizedBox(height: 16),
          _buildFeatureItem(
            Icons.bolt_rounded,
            'Priority Search Placement',
            'Appear at the top of client searches.',
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'Your benefits will activate immediately upon confirmation.',
            textAlign: TextAlign.center,
            style: TextStyle(fontSize: 14, color: Color(0xFF9ECAFF)),
          ),
          const SizedBox(height: 24),
          SizedBox(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                Expanded(
                  child: Container(
                    ...
                    height: 32,
                    decoration: BoxDecoration(
                      color: const Color(0xFF004779).withOpacity(0.3),
          ...
          const SizedBox(height: 16),
          const Text(
            'Elite providers see 40% more engagement on average.',
            textAlign: TextAlign.center,
